#!/usr/bin/env python3
"""Verify eval prerequisites: API settings, PostgreSQL collection, Milvus vector dim."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Check CQADupStack / Unix eval setup")
    ...
    if ok:
        print("\nReady. Run:")
        print("  python eval/cqadupstack_unix/import_corpus.py --purge --limit 200")
        print("  python eval/cqadupstack_unix/run_eval.py --query-limit 50")
        return 0

#!/usr/bin/env python3
"""Create the eval PostgreSQL collection row (required before corpus import)."""
...
MIGRATION = ROOT / "migrations" / "006_eval_cqadupstack_unix.sql"
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Apply eval collection migration to PostgreSQL")

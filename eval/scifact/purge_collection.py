#!/usr/bin/env python3
"""Delete all documents in the SciFact eval collection (reset before re-import)."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Purge SciFact eval collection documents")

#!/usr/bin/env python3
"""Run retrieval evaluation (Hit@K / MRR@K) for BEIR SciFact."""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(description="Evaluate SciFact retrieval")
    ...
    out_path = args.output or str(REPORT_DIR / f"scifact-{ts}.json")
    report = {

...
function emptyForm(): AppSettings {
  return {
    ...
    milvus_hnsw_ef: 64,
    milvus_sparse_drop_ratio_build: 0.2,
    milvus_sparse_drop_ratio_search: 0,
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const payload: AppSettingsUpdate = {
        ...
        chunk_max_tokens: form.chunk_max_tokens,
        chunk_overlap_tokens: form.chunk_overlap_tokens,
        search_top_k: form.search_top_k,
        search_score_threshold: form.search_score_threshold,
        search_mode: form.search_mode,
        search_hybrid_enabled: form.search_hybrid_enabled,
        search_dense_weight: form.search_dense_weight,
        search_bm25_weight: form.search_bm25_weight,
        search_recall_k: form.search_recall_k,
        search_rerank_enabled: form.search_rerank_enabled,
        rerank_api_url: form.rerank_api_url,
        ...
        milvus_sparse_drop_ratio_build: form.milvus_sparse_drop_ratio_build,
        milvus_sparse_drop_ratio_search: form.milvus_sparse_drop_ratio_search,

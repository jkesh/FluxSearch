...
FluxSearch 技术文档按主题拆分，便于查阅与维护。

## 文档目录

| 文档 | 受众 | 内容 |
|------|------|------|
| [architecture.md](architecture.md) | 全员 | 系统架构、组件关系、服务划分 |
| [tech-stack.md](tech-stack.md) | 开发者 | 前后端技术选型与依赖 |
...
1. [architecture.md](architecture.md) — 理解整体
2. [development.md](development.md) — 跑通本地环境
3. [api.md](api.md) — 了解前后端契约
